    ...
    <>
      ...
      <header className="js-page-header fixed top-0 z-20 w-full backdrop-blur transition-colors">
        <div className="flex items-center px-6 py-6 xl:px-24 ">
          ...
          {/* End  logo */}
          <ul className="flex flex-col lg:flex-row ml-12 bg-red  rounded-lg">
            {/* create */}
            <li className="group">
              <Link href="/create">
                <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-2.5 text-base dark:text-white lg:px-5">
                  <span
                    className={
          ...
          <ul className="flex flex-col lg:flex-row ml-3 bg-red  rounded-lg">
            {/* create */}
            <li className="group">
              <Link href="/create">
                <button className="text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-2.5 text-base dark:text-white lg:px-5">
          ...
          <div className="flex justify-center w-full">
            ...
            >
              <input
                type="search"
                className="text-jacarta-700 placeholder-jacarta-500 focus:ring-accent border-jacarta-100 w-[333px] rounded-lg border py-[0.6875rem] px-4 pl-10 dark:border-transparent dark:bg-white/[.15] dark:text-white dark:placeholder-white"
                placeholder="Search"
              />
            ...
            <div className="ml-8 hidden items-center lg:flex xl:ml-12">
              ...
              <div className="js-nav-dropdown group-dropdown relative">
                <button className="dropdown-toggle border-jacarta-100 hover:bg-accent focus:bg-accent group dark:hover:bg-accent ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]">
                  <img src="/images/insight.png" className="w-5" />
                </button>
                <div className="dropdown-menu dark:bg-jacarta-800 group-dropdown-hover:opacity-100 group-dropdown-hover:visible !-right-4 !top-[85%] !left-auto z-10 min-w-[14rem] whitespace-nowrap rounded-xl bg-white transition-all will-change-transform before:absolute before:-top-3 before:h-3 before:w-full lg:absolute lg:grid lg:!translate-y-4 lg:py-4 lg:px-2 lg:shadow-2xl hidden lg:invisible lg:opacity-0">
                  ...
                  >
                    <span className="font-display text-jacarta-700 mt-1 text-sm  flex justify-center items-center gap-1 dark:text-white">
                      <img
                        src="/images/drop.svg"
                        alt=""
                        className="w-4 dark:filter dark:invert"
                      />
                      Drops
                    </span>
                  </Link>
                  ...
                  <Link
                    ...
                    className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors"
                  >
                    <span className="font-display text-jacarta-700 mt-1 text-sm dark:text-white flex justify-center content-center gap-1">
                      {" "}
                      <img
                  ...
                  <Link
                    ...
                    className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors"
                  >
                    <span className="font-display text-jacarta-700 mt-1 text-sm dark:text-white flex justify-center items-center gap-1">
                      <img
                        src="/images/activity-log-icon.svg"
                        alt=""
                        className="w-4 dark:filter dark:invert"
                      />
                      Activity
                  ...
                  <Link
                    ...
                    className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors"
                  >
                    <span className="font-display text-jacarta-700 mt-1 text-sm dark:text-white flex content-center justify-center gap-1">
                      <img
                        src="/images/cart.svg"
                        alt=""
                        className="w-4 dark:filter dark:invert"
